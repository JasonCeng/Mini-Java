...
import zzc.com.dao.GoodsDao;
import zzc.com.entity.Goods;
import zzc.com.tools.QueryPrint;
	...
	public static void deleteGoodsPage() {
		...
		do {
			...
			if ("y".equals(choice) || "Y".equals(choice)) {
				// 进行删除-数据库操作
				boolean boolDeleteGoods = new GoodsDao().deleteGoods(gid);// 调用删除功能
